...
// 3 группы
// Порождающие(отвечают за создание), структурные(какова будет структура) и поведенческие(взаимодействие)

// Singleton иногра называют антипатерн
// гарантирует, что у класса есть один инстанс
// class Sun {
...
//   }
//   transport(to) {
//     console.log(`Доставка груза в ${to} используя ${this.type}`);
//   }
// }
...
// const logisticFabric = new Logistic();
